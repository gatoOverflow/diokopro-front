...
export const FORGOT_PASSWORD_V2_URL = `${API_URL}/auth/forgot-password-v2`
export const RESET_PASSWORD_V2_URL = `${API_URL}/auth/reset-password-v2`
...
export const PAYMENT_FOR_ALL_AGENTS_ENTREPRISE = `${API_URL}/paymentEntreprise`
export const PAYMENT_FOR_ALL_CLIENTS_ENTREPRISE = `${API_URL}/payment-links`
...
export const GET_PENDING_SCHEDULED_PAYMENTS = `${API_URL}/getPendingScheduledPayments`;
